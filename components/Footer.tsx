      ...
      <div className="flex flex-col gap-12 w-full">
        <div className="flex items-start flex-col">
          ...
          <p className="text-start text-sm font-normal mt-5 max-w-xs">
            ...
            nam nostrum iste libero alias maxime pariatur velit reprehenderit.
            Suscipit totam dolores minima quibusdam rerum voluptas quasi
            repudiandae itaque nobis atque.
          </p>
        </div>
